...
export function getRecommend () {
  // 线上环境地址
  const url = debug ? '/api/getTopBanner' : 'http://xyz.xiesquan.site/music/api/getTopBanner'
...
export function getDiscList() {
  const url = debug ? '/api/getDiscList' : 'http://xyz.xiesquan.site/music/api/getDiscList'
...
export function getSongList (disstid) {
  const url = debug ? '/api/getCdInfo' : 'http://xyz.xiesquan.site/music/api/getCdInfo' 
