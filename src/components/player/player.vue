        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar ref="progressBar" @percentChange="onProgressBarChange" :percent="percent" @percentChanging="onProgressBarChanging"></progress-bar>
            </div>
    ...
    methods: {
      ...
      handleLyric({ lineNum, txt }) {
        ...
        if (lineNum > 1) {
          ...
          this.$refs.lyricList.scrollToElement(lineEl, 1500)
        } else {
          this.$refs.lyricList.scrollTo(0, 0, 1500)
        }
